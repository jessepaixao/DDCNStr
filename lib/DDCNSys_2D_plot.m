function [Z_rec,opt_data,elapsedTime] = DDCNSys_2D_plot(Z_rec,Z_star,Z_test,opt_data,tspan_test,u_test,datadriven_solver,animation_config)
...
myVideo           = VideoWriter(animation_config.file_name,'MPEG-4');
myVideo.Quality   = animation_config.Quality;  
myVideo.FrameRate = animation_config.FrameRate;
...
h3=subplot(3,2,[2 4 6]);
cla(h3)

frame_steps=animation_config.Frame_steps;
